...
class EntrepreneurPage extends StatefulWidget {
  EntrepreneurPage({required Key key}) : super(key: key);
...
class _EntrepreneurPageState extends State<EntrepreneurPage> {
  ...
  void _changeEmployee() {
    int randomNumber = random.nextInt(employees.length);
    if (randomNumber == employeeIndex) {
      _changeEmployee();
    } else {
      setState(() {
        employeeIndex = randomNumber;
      });
    }
  }
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              leading: Icon(Icons.adjust_rounded),
              title: Text('Biznesa idejas apraksts:'),
            ),
            ListTile(
              dense: true,
              leading: Icon(Icons.message, color: Colors.white),
          ...
          child: Column(
            ...
            children: [
              Expanded(
                flex: 5,
                child: Card(
                  child: CarouselList(employeeIndex: employeeIndex,key: ValueKey(null)),
                      ...
                      onPressed: () => showDialog(
                        ...
                        builder: (BuildContext context) => AlertDialog(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed: () => _launchURL(Uri(
                                          scheme: 'mailto',
                                          path: employees[employeeIndex].email,
                                          query:
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed: () => _launchURL(Uri(
                                          scheme: 'tel',
                                          path: employees[employeeIndex].phone)
                                      .toString()),
                                  child: Text(
                          ...
                          actions: [
                            TextButton(
                              onPressed: () =>
                                  {Navigator.pop(context), _changeEmployee()},
...
class CarouselCard extends StatelessWidget {
  CarouselCard({required this.employee, required this.index});
...
class CarouselList extends StatefulWidget {
  ...
  CarouselList({required Key key, required this.employeeIndex}) : super(key: key);
              ...
              child: PageView.builder(
                itemBuilder: (context, index) {
                  return Opacity(
                    ...
                    child: CarouselCard(
                        employee: employees[widget.employeeIndex],
                        index: index),
                  );
                },
                itemCount: 2,
